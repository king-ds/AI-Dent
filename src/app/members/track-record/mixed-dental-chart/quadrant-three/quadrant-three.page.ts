...
@Component({
  selector: 'app-quadrant-three',
  templateUrl: './quadrant-three.page.html',
  styleUrls: ['./quadrant-three.page.scss'],
})
export class QuadrantThreePage implements OnInit {
  ...
  ionViewWillEnter(){
    this.loader = true;
    let teethNumber = [31, 32, 33, 34, 35, 36, 37, 38, 71, 72, 73, 74, 75]

    // Check for the existing teeth number
    this.apiService.getDentalChartQ3(this.trackRecord['id']).subscribe((val : any) => {
